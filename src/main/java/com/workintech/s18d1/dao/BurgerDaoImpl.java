...
public class BurgerDaoImpl implements BurgerDao {
    ...
    @Override
    public List<Burger> findByContent(String string) {
        TypedQuery<Burger> query = entityManager.createQuery("SELECT b FROM Burger b WHERE b.contents ILIKE %:string%", Burger.class);
        query.setParameter("contents", string);
        return query.getResultList();
    }
